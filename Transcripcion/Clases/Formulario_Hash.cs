...
namespace Hash
{
    public class Formulario_Hash
    {
        ...
        public void Contar()
        {
            ...
            && a.Extension != ".png" && a.Extension != ".jpg" && a.Extension != ".jpeg" && a.Extension != ".bmp"
            && a.Extension != ".mp4" && a.Extension != ".avi" && a.Extension != ".mov"
            && a.Extension != ".mp3" && a.Extension != ".wav" && a.Extension != ".flac");
